...
<nav class="simple-admin-nav">
    <div class="simple-nav-container">
        ...
        <div class="landing-nav-links">
            ...
            <a href="inventory.php" class="landing-nav-link <?= $current_page === 'inventory.php' ? 'active' : '' ?>">
                Inventory
            </a>
            <a href="add_product.php" class="landing-nav-link <?= $current_page === 'add_product.php' ? 'active' : '' ?>">
                Add Product
            </a>
